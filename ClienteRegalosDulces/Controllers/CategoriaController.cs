...
namespace ClienteRegalosDulces.Controllers
{
    ...
    public class CategoriaController : Controller
    {
        ...
        {
            _svc = CategoriaService ?? throw new ArgumentNullException(nameof(CategoriaService));
        }
        ...
        {
            return View(id > 0 ? await _svc.GetItem(id) : new Categoria());
        }
        ...
        public async Task<IActionResult> Save([FromForm] Categoria model)
        {
            try
            {
                var r = new Categoria();
